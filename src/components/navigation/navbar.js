        ...
        <div>
             <Desktop>
                 ...
                 <div className="desktopNavWrapper">
                     ...
                     <div className={background ? "desktopNavContent active" : "desktopNavContent"}>
                         <div className="webNameDesktop">
                             <HomeRedirect webname="WONDERS"/> 
                             <img src={webLogo} alt="Web Logo" />
                         </div>

                         <div className={color ? "desktopNavComponents active" : "desktopNavComponents"}>
                            <div>
                                <Link to="/">Home</Link>
                            </div>
                            <div>
                            ...
                            <div className="desktopSignUpWrapper">
                                <Link to="/signup">
                                    <Button variant="outline-light" id="desktopSignUpButton">Sign Up</Button>
                                </Link>
                            </div>
                         </div>
                     </div>
                    ...
                    <div className="mobileNavContent">
                        ...
                        <div onClick={handleClick} className="navHam">
                            {click ? (
                                ...
                                <Hamburger rounded toggle={setOpen} color="white"
                                size={35} />
                            )}
                        </div>
                    </div>
                    ...
                    <div className={click ? "navComponentsMobile" : "navComponents"}>
                        ...
                        <div className="signButtonWrapper">
                            <Link to="/signup" onClick={closeMobileMenu}>
                                <Button variant="outline-light" id="signUpButton">Sign Up</Button>
                            </Link>
                        </div>
                    </div>
